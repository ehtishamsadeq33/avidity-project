...
export default function AdminLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(message);
      if (message.toLowerCase().includes("mongo") || message.toLowerCase().includes("database")) {
        setHint("The admin panel needs a MongoDB database connection before sign-in can work.");
      }
    } finally {
      setLoading(false);
    }
