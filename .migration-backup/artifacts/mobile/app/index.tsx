  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        <Text style={styles.title}>Coach Readiness{"\n"} Assessment</Text>
      </View>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          You have been selected to complete the Coach Readiness Assessment. We
          would like you to pay attention to the following conditions:
        </Text>
